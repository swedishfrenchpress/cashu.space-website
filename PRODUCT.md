...
4. **Editorial pacing.** Massive display type at the hero, generous whitespace between sections, long single-column reads. The hero earns its size; nothing competes with it. Sections breathe.
   ...
   *Scoped 2026-08-14 and **unscoped 2026-08-20**, both on the user's direction.* For six days the homepage hero was **centred** while everything else stayed left-aligned editorial — a real tension with "editorial-minimal, confident through silence" above, weighed and chosen at the time. It is reverted: **the hero sets flush left like every other surface, and the site has no alignment exception left.** The coupled moves it required were made and measured; see the Centred-Hero Exception's retirement in DESIGN.md §4.

   *Also 2026-08-20:* the hero is a **split** — type left, the cipher field holding the right and bleeding off the edge. That is in tension with two clauses of this principle, and the tension is real rather than explained away. "Long single-column reads" still governs everything below the fold, and the hero was never one of those. "Nothing competes with it" is the sharper one: what sits beside the headline is a **ground** and not a figure — unframed, wordless, asserting nothing, dissolving into the page — and the geometric terms that keep it that way are written down at the Honest-Network Rule's 2026-08-20 amendment in DESIGN.md §4. **If it ever acquires a fourth edge it is competing, and this principle is the thing it is competing with.**
