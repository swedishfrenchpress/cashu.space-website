          ...
          <div className="footer-card__bottom">
            <div className="footer-card__bottom-left">
              <div className="footer-socials">
                ...
                >
                  <span className="sr-only">X (Twitter) (opens in a new tab)</span>
                ...
                <ExternalLink
                  ...
                  className="footer-social focus-ring--on-ink"
                >
                  <span className="sr-only">Nostr (opens in a new tab)</span>
            ...
            <div className="footer-card__bottom-right">
              ...
              <div className="footer-ai">
                {AI_LINKS.map((ai) => (
                  ...
                  >
                    <span className="sr-only">{ai.name} (opens in a new tab)</span>
